      ...
      <div className="flex md:hidden flex-col items-center flex-1 pb-6">
        <FadeIn delay={0.15} y={40}>
          <h1
            ...
            style={{ fontSize: 'clamp(3.2rem, 17vw, 5.5rem)', marginTop: '8px', paddingLeft: '8px', paddingRight: '8px' }}
          >
            NonsoDev
          </h1>
        </FadeIn>
        ...
        <FadeIn delay={0.4} y={30}>
          <div style={{ display: 'flex', justifyContent: 'center', width: '100%', marginTop: '8px' }}>
            <img
              ...
              style={{ width: 'clamp(180px, 60vw, 280px)', display: 'block' }}
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', width: '100%', padding: '16px 20px 0', marginTop: 'auto' }}>
          <FadeIn delay={0.5} y={20}>
            <div style={{ color: '#D7E2EA', fontSize: 'clamp(0.55rem, 3vw, 0.8rem)', textTransform: 'uppercase', letterSpacing: '0.05em', lineHeight: 1.5, maxWidth: '48%', fontWeight: 300 }}>
              <span>building </span>
              <span style={{ color: '#B600A8', fontWeight: 700 }}>{displayed}<span>|</span></span>
