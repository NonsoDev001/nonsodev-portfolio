...
const EMAIL = 'chukwunonsoofforka@gmail.com'
const LINKEDIN = 'https://www.linkedin.com/in/chukwunonso-offorka-187a60404'
    ...
    >
      <FadeIn delay={0} y={40}>
        <h2
          ...
          style={{ fontSize: 'clamp(3rem, 12vw, 140px)', marginBottom: '16px' }}
        >
          Contact
        </h2>
      </FadeIn>
        ...
        {contacts.map((c, i) => (
          <FadeIn key={c.label} delay={i * 0.12} y={30}>
            ...
            >
              ...
              <div>
                <p className="font-black uppercase" style={{ color: '#D7E2EA', fontSize: 'clamp(1.2rem, 2.5vw, 1.8rem)', lineHeight: 1 }}>
                  {c.label}
                </p>
                <p className="font-light" style={{ color: '#D7E2EA', opacity: 0.5, fontSize: 'clamp(0.75rem, 1.3vw, 0.95rem)', marginTop: '8px', lineHeight: 1.5 }}>
                  {c.description}
                </p>
              </div>
